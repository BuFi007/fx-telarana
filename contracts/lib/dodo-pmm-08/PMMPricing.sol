...
//   commit 46ad8622cfe620b85473b829ca39e2bfb53f858c
//   path:   src/mimswap/libraries/PMMPricing.sol
// Only deviation from upstream: import paths adapted to local directory layout
// (Abracadabra's `/mimswap/libraries/...` remapping → relative path).
