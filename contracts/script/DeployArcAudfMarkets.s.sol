...
contract DeployArcAudfMarkets is Script {
    ...
    address internal constant DEFAULT_IRM = 0x8CC1B64D712eE2ff2891D56a5108eC4FDa73b9c1;
    ...
    function run() external {
        ...
        require(registryOwner == deployer, "DeployArcAudfMarkets: deployer is not the live FxMarketRegistry owner");
        ...
        IFxMarketRegistry.MarketParams memory m3 = IFxMarketRegistry.MarketParams({
            loanToken: audf, collateralToken: usdc, oracle: address(adapterM3), irm: irmAddr, lltv: lltv
        });
        IFxMarketRegistry.MarketParams memory m4 = IFxMarketRegistry.MarketParams({
            loanToken: usdc, collateralToken: audf, oracle: address(adapterM4), irm: irmAddr, lltv: lltv
        });
