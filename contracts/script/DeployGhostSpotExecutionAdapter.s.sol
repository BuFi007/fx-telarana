...
///
/// The web app's BufiOwnStackProvider submits `relayExecute` with adapterId=3
/// for fx-router spot swaps. This script deploys the corresponding
/// FxSpotSwapAdapter, authorizes it on the v4-backed FxRouterSwapAdapter, and
/// registers it in the live FxPrivacyEntrypoint.
