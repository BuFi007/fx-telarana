...
- [ ] **Run the Morpho dependency gate before broadcast** — `forge script contracts/script/VerifyArcMorphoTestnet.s.sol:VerifyArcMorphoTestnet --root contracts --rpc-url "$ARC_TESTNET_RPC_URL" -vv`.
